...
def PlotBasinsArea(Sc,BasinData,thresh,alpha):
    ...
    plt.plot(x,y,color=alpha,marker='o',linestyle='',markeredgecolor=alpha,label='Min. Basin Data Points = '+str(thresh))   
...
def MakeThePlot(Path,Prefix,Sc_Method,RawFlag,DensityFlag,BinFlag,NumBins,PatchFlag,BasinFlag,LandscapeFlag,Order,ErrorBarFlag=True,Format='png',ComparisonData=(False,False,False),NumBootsraps=10000):
    ...
    if BasinFlag:
        ...
        PlotBasinsArea(Sc,BasinData,10,'gold')
        #PlotBasinsArea(Sc,BasinData,10,'darkorange')
        PlotBasinsArea(Sc,BasinData,100,'r')
        PlotBasinsArea(Sc,BasinData,1000,'darkred')
    if LandscapeFlag:
